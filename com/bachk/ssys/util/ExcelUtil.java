...
public class ExcelUtil {
    ...
    public static int getColumnNumber(String columnChar){
    	int number = 0;
    	int scale = 1;
    	for (int i = columnChar.length() - 1; i >= 0 ; i--){
    		char c = columnChar.charAt(i);
    		number += ((c - 'A') + 1) * scale;
    		scale *= 26;
    	}
    	return number-1;
    ...
    public static void main(String[] args) {
		System.out.println(ExcelUtil.getColumnNumber("AB"));
	}
